...
<template>
    <Widget>
        ...
        <h4 class="h4">Edit Targets</h4>
        
                <b-form-group
                    label="Name"
                    label-for="idm308429204656"
                >
                    <b-form-input
                       v-model="name"
                       type="text"
...
export default {
  ...
  computed: {
    ...mapState({
        data: state => state.targetsForm.data,
    ...
    methods: {
    ...mapActions({
        getData: 'targetsForm/getData',
        
        edit: 'targetsForm/edit'
    }),
    async submitHandler() {
        ...
        try {
            ...
            this.$router.push('/admin/targets')
        } catch (e) {
